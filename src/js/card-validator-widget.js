...
class CardValidator {
    constructor(widgetWrapper) {
        ...
        this.formTooltip = widgetWrapper.querySelector('.form__wrapper .form__tooltip');
    }
    ...
    getAllCardIcons () {
        return this.widgetWrapper.querySelectorAll('.card-icon__list .card-icon__wrapper');
    }

    getCardIconByTag (tag) {
        return this.widgetWrapper.querySelector(`.card-icon__list #card-icon__${tag}__wrapper`);
    }
}
